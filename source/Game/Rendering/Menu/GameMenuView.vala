...
class GameMenuView : View2D
{
    ...
    private LabelControl riichi_label;
    ...
    private bool riichi_active = false;

    private void toggle_riichi_active()
    {
        riichi_active = !riichi_active;
        if (riichi_label != null)
        {
            riichi_label.visible = riichi_active;
        }
    }

    public void reset_riichi_active()
    {
        riichi_active = false;
        if (riichi_label != null)
            riichi_label.visible = false;
    }
    ...
    public override void added()
    {
        ...
        riichi_label = new LabelControl();
        add_child(riichi_label);
        riichi_label.inner_anchor = Vec2(0.5f, 0);
        riichi_label.outer_anchor = Vec2(0.5f, 0);
        riichi_label.position = Vec2(0, padding * 2);
        riichi_label.font_size = 30;
        riichi_label.visible = false;
        riichi_label.text = "RIICHI - Select tile to discard";
        riichi_label.color = Color(1.0f, 0.8f, 0.0f, 1);
        riichi_label.selectable = false;
